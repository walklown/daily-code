...
class Solution220227 {
    ...
    public static void main(String[] args) {
        Solution220227 solution = new Solution220227();
        System.out.println(solution.optimalDivision(new int[] {7, 1, 5, 4}));
    }

    public String optimalDivision(int[] nums) {
        StringBuilder builder = new StringBuilder().append(nums[0]);
        if (nums.length == 1) {
