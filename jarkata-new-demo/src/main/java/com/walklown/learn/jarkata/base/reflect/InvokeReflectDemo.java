...
//    }
    ...
    private static final Person person = new Person("zhang", "12345678");

    public InvokeReflectDemo() {
        MethodHandles.Lookup lookup = MethodHandles.lookup();
    ...
    public static void main(String[] args) {
        InvokeReflectDemo demo = new InvokeReflectDemo();
        String name = (String) demo.getterFunction.apply(person);
    }
}
