...
//    }
    ...
    public static void main(String[] args) throws JsonProcessingException {
        ...
        LocalDate localDate = LocalDate.parse("+999990101", DateTimeFormatter.ofPattern("yyyyMMdd"));
        System.out.println(localDate);
        System.out.println(LocalDate.MAX);
        System.out.println(LocalDate.MAX.format(DateTimeFormatter.ofPattern("yyyyMMdd")));
    }
}
