...
public class MyBatisDemo {
    ...
    public static SqlSession getSqlSession() throws FileNotFoundException {
        ...
        InputStream configFile = new FileInputStream(
                "D:\\wks\\gupaoedu-mybatis-master-e4043a9342d1936369eeb63e79ea4d0250d447c0\\src\\main\\java\\com\\gupaoedu\\mybatis\\demo\\mybatis-config.xml");
...
//            System.out.println(getPosts(sqlSession, 1));
            System.out.println(insert(sqlSession, new Test(1, 66, "test insert")));
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            sqlSession.commit();
